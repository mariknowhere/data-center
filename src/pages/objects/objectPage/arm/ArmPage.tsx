...
import {selectArm, selectArmById} from '../../../../store/objects/arm/armSelectors';
...
/**
 * Component for displaying information on arm page.
 *
 */
const ArmPage: FC = () => {
  ...
  const { logs } = useAppSelector(selectArm);
  ...
  const {
    ...
    pentesters,
    is_delete: isDelete,
  } = useAppSelector(selectArmById);

  const [isChangeProjectModal, setChangeProjectModal] = useState<boolean>(false);
  const [isDeleteArmModal, setDeleteArmModal] = useState<boolean>(false);
  ...
  const onConfirmDeleteModalHandler = () => setDeleteArmModal(prevState => !prevState);
  ...
  return (
    <>
      ...
      <div className={styles['item-content']}>
            ...
            <div className={styles['item-body']}>
              <div className={styles['item-body-info']}>
                <Title className={styles['item-body-info-title']} variant={TitleVariantEnum.H3}>
                  {localization.object.infoArmTitle}
                </Title>
                ...
                <div className={styles['item-panel-top-wrapper']}>
                  <div className={styles['item-panel-top']}>
                    <Title className={styles['item-panel-top-title']} variant={TitleVariantEnum.H3}>
                      <>
                        {localization.object.interactiveArmTitle}
                        {isDelete && (
                          <Archive />
                        )}
                      </>
        ...
        <ConfirmModal
          isModalVisible={isDeleteArmModal}
          setModalVisible={setDeleteArmModal}
